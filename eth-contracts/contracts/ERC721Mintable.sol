...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Owner is not a real address");
        _owner = newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public whenNotPaused {
        ...
        require(to != ownerOf(tokenId), "Owner cannot be address to transfer to");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((msg.sender == ownerOf(tokenId) || isApprovedForAll(ownerOf(tokenId), msg.sender)), "Msg sender has to be owner of contract or an approved operator");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(_tokenOwner[tokenId] == from, "Address has to be owner of given token");

        // TODO: require token is being transfered to valid address
        require(to != address(0), "Address being transferred to has to be valid");
     ...
     * @param to target that will receive the tokens
     * @param tokenId uint256 ID of the token to be transferred
...
contract CustomERC721Token is ERC721Metadata(
    "Bitland", "BLC", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"
    ) {
